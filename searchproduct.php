...
<div class="cat_menu_container">
								...
								<div class="cat_menu_title d-flex flex-row align-items-center justify-content-start">
									...
									<div class="cat_menu_text"><h3>Categories</h3></div>
...
<?php
	...
	if (isset($_GET['catid'])){
		...
		$findname = "select name from category where catid = '$categoryid'";
		$nameresult = mysqli_query($db,$findname);
	...
	if (isset($_POST['search'])){
			...
			$sql_query = "SELECT * FROM products WHERE pname LIKE '%{$pname}%' OR description LIKE '%{$pname}%'";
